                    ...
                    $stmt3 = $conn->prepare("SELECT start.start_random as start_random, start.start_date, used.list_id as list_id, used.list_barcode as list_barcode, category.fac_name as fac_name
                      ...
                      while($row3 = $result3->fetch_assoc())
                      {
                        ...
                        <tr align="center">
                          ...
                          <td><button class="btn btn-success btn-sm" onclick="window.location.href='transaction_queue_qrcode.php?list_id=<?php echo $list_id;?>'"><i class='fa fa-check-circle'></i></button></td>
                        </tr>
                      <?php }?>
                    </tbody>
                  </table>
