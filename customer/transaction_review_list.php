  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb side">
        ...
        <li class="breadcrumb-item active">Review Facilities</li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="bs-component">
          <div class="card">
            <h5 class="card-header">Review Facilities</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-9">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <div class="table-responsive">
                <table width="100%" class="table table-hover table-bordered">
                  ...
                  <tbody>
                    ...
                    $stmt3 = $conn->prepare("SELECT start.start_id as start_id, start.start_random as start_random, used.list_id as list_id, used.list_barcode as list_barcode, category.fac_name as fac_name
                      ...
                      AND start.cust_id =? AND used.list_status=? AND used.list_review=? ORDER BY used.list_finish ASC");
                      ...
                      while($row3 = $result3->fetch_assoc())
                      {
                        ...
                        <tr align="center">
                          ...
                          <td><button class="btn btn-warning btn-sm" style="color:white;" onclick="window.location.href='transaction_review_rating.php?list_id=<?php echo $list_id;?>'"><i class='fa fa-star'></i></button></td>
                        </tr>
                      <?php }?>
                    </tbody>
                  </table>
