  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" class="modal-header">Maintenance <small>Edit Paddle Boat</small></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <form action="garage_electric_view_update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
