  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb side">
        ...
        <li class="breadcrumb-item active">Damage Electric Boat</li>
      </ul>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="bs-component">
          <div class="card">
            <h5 class="card-header">Damage Electric Boat</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-9">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $stmt = $conn->prepare("SELECT damage.dam_elc_id as dam_id, damage.dam_elc_date as dam_date, damage.dam_elc_canopy as dam_canopy, damage.dam_elc_pole as dam_pole, damage.dam_elc_seat as dam_seat,
                      damage.dam_elc_motor as dam_motor, damage.dam_elc_crack as dam_crack, damage.dam_elc_leak as dam_leak, damage.rep_elc_status as rep_status,
                      ...
                      AND  damage.rep_elc_status=? AND damage.done_elc_status=? ORDER BY damage.dam_elc_date ASC");
                      ...
                      <tr align="center">
                        ...
                        <td><a href="maintenance_electric_damage_delete.php?new_id=<?php echo $new_id; ?>&&dam_id=<?php echo $dam_id; ?>" onclick="return confirm('Are you sure?');"><button  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
