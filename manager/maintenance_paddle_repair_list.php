  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb side">
        ...
        <li class="breadcrumb-item active">Repair Paddle Boat</li>
      </ul>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="bs-component">
          <div class="card">
            <h5 class="card-header">Repair Paddle Boat</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-9">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  ...
                  $stmt = $conn->prepare("SELECT  damage.dam_pad_id as dam_id, damage.dam_pad_date as dam_date, damage.rep_pad_status as rep_status, damage.rep_pad_date as rep_date,
                    ...
                    AND  damage.rep_pad_status=? AND damage.done_pad_status=? ORDER BY damage.rep_pad_date ASC");
