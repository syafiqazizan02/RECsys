  ...
  <tbody>
    ...
    while($row = $result->fetch_assoc())
    {
      ...
      <tr align="center">
        ...
        <td>
          <?php include('registration_visitor_info.php'); ?>
          <a href="#info<?php echo $cust_id; ?>" data-toggle="modal" class="btn btn-warning btn-sm" style="color:white"><i class='fa fa-edit'></i></a>
