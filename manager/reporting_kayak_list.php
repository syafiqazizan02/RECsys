  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb side">
        ...
        <li class="breadcrumb-item active">History Kayak</li>
      </ul>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="bs-component">
          <div class="card">
            <h5 class="card-header">History Kayak</h5>
            <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr align="center">
                      ...
                      <td align="center">
                        <a href="reporting_kayak_view.php?new_id=<?php echo $new_id; ?>" ><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-bullseye"></i></button></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
