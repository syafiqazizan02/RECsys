...
<div class="modal fade" id="edit<?php echo $dam_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
          ...
          <h5 class="modal-title" class="modal-header">MAINTENANCE <small>Paddle Boat</small></h5>
            ...
            <div class="col-lg-12"><br />
              <table class="table table-bordered" class="table table-sm">
                <thead bgcolor=#f8f8f8>
                  ...
                  <tbody>
                  <?php
                      $stmt3 = $conn->prepare("SELECT  damage.dam_pad_id as dam_id, damage.dam_pad_canopy as dam_canopy, damage.dam_pad_pole as dam_pole, damage.dam_pad_seat as dam_seat,damage.dam_pad_paddle as dam_paddle, damage.dam_pad_crack as dam_crack, damage.dam_pad_leak as dam_leak,
                      damage.done_date_canopy as date_canopy, damage.done_date_pole as date_pole, damage.done_date_seat as date_seat,damage.done_date_paddle as date_paddle, damage.done_date_crack as date_crack, damage.done_date_leak as date_leak,
                      damage.done_price_canopy as price_canopy, damage.done_price_pole as price_pole, damage.done_price_seat as price_seat,damage.done_price_paddle as price_paddle, damage.done_price_crack as price_crack, damage.done_price_leak as price_leak,
                      damage.done_pad_price as done_price, facility.new_id as new_id, facility.new_code as new_code
                      FROM `damage_paddle` AS damage
                      JOIN `facility_new` AS facility ON damage.new_id=facility.new_id
                      AND  damage.dam_pad_id=? ");
                      ...
                      while($trow = $result3->fetch_assoc())
                      {
                        ...
                        $date_paddle = date_format(date_create($trow['date_paddle']), 'd/m/Y');
                        ...
                        $price_paddle = $trow['price_paddle'];
                        ...
                        if($dam_paddle==1){
                          echo "<tr align='center'>";
                          echo "<td><p>Paddle</p></td>";
                          echo "<td><p>$date_paddle</p></td>";
                          echo "<td><p>RM $price_paddle</p></td>";
                          echo "</tr>";
                        }
                        if($dam_crack==1){
                          echo "<tr align='center'>";
