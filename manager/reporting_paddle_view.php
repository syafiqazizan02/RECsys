    ...
    <div class="row">
      <div class="col-md-12">
        <div class="bs-component">
          <div class="card">
            <h5 class="card-header">Detail Paddle Boat</h5>
            <div class="card-body">
              <table class="table table-hover table-bordered" id="data-table">
                <thead bgcolor=#f8f8f8>
                  <tr align="center">
                    <th colspan="5">Paddle Boat: <?php echo $new_code;?></th>
                  </tr>
                  <tr align="center">
                    <th>No.</th>
                    <th>Damage Date</th>
                ...
                <tbody>
                  <?php
                    ...
                    $stmt = $conn->prepare("SELECT * FROM `damage_paddle` WHERE new_id=? AND done_pad_status=? ORDER BY done_pad_date DESC");
                    ...
                    {
                      $dam_id= $row['dam_pad_id'];
                      $dam_date = date_format(date_create($row['dam_pad_date']), 'd/m/Y');
                      $rep_date = date_format(date_create($row['rep_pad_date']), 'd/m/Y');
                      $done_date = date_format(date_create($row['done_pad_date']), 'd/m/Y');
                      $u++
                  ?>
                    <tr align="center">
                      <td><?php echo $u; ?></td>
                      ...
                      <td align="center">
                        <?php include ('reporting_paddle_detail.php'); ?>
