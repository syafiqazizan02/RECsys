  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" class="modal-header">TRANSACTION <small>Facilities Detail</small></h5>
      ...
      <div class="modal-body">
        ...
        include "dbconnection.php";
          ...
          $stmt2 = $conn->prepare("SELECT start.start_id as start_id, start.start_random as start_random, start.start_date as start_date,
            customer.cust_ic as cust_ic, customer.cust_name as cust_name, customer.cust_email as cust_email, customer.cust_contact as cust_contact
            ...
            <table width="100%" class="table table-hover table-bordered">
              <thead bgcolor=#f8f8f8>
                <tr align="center">
                  ...
                  <th>Facilities Start</th>
                  <th>Facilities Finish</th>
                </tr>
              </thead>
              <tbody>
                <?php
                ...
                $stmt3 = $conn->prepare("SELECT used.list_barcode as list_barcode, used.list_start as list_start, used.list_finish as list_finish, used.list_status as list_status,
                  category.fac_name as fac_name
                  ...
                  while($row3 = $result3->fetch_assoc())
                  {
                    ...
                    $list_start = date_format(date_create($row3 ['list_start']), 'g:i A');
                    $list_finish = date_format(date_create($row3 ['list_finish']), 'g:i A');
