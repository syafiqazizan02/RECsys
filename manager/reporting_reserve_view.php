...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h4>TRANSACTION</h4><span id="date_time"></span></small>
      </div>
            ...
            <div class="card-body">
              <table class="table table-hover table-bordered" id="data-table">
                ...
                <tbody>
                  ...
                  customer.cust_name as cust_name, COUNT(list.list_id) AS a
                  ...
                  AND list.list_status=2 GROUP BY list.start_id ORDER BY start.start_id DESC");
                  ...
                  $result = $stmt->get_result();
                    ...
                    while($row = $result->fetch_assoc())
                    {
                      ...
                      <tr align="center">
                        ...
                        <td><?php echo $a; ?></td>
                        <td>
                          <?php include ('reporting_reserve_detail.php'); ?>
                          <a href="#view<?php echo $start_id; ?>" data-toggle="modal" class="btn btn-info btn-sm"><i class='fa fa-bullseye'></i></a>
                        </td>
                        <td align="center">
                          <form action="reporting_reserve_print.php" method="post" enctype="multipart/form-data" target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=800,height=500');">
