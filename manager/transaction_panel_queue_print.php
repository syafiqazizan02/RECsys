  ...
  <body>
      ...
      <div class="box-body table-responsive">
        ...
        <table border="1" cellpadding="0" cellspacing="0" width="100%">
          ...
          $stmt2 = $conn->prepare("SELECT used.list_barcode as list_barcode, used.list_qty as list_qty, used.list_total as list_total, category.fac_name as fac_name, category.fac_rate as fac_rate
