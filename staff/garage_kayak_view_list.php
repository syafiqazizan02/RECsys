  ...
  <tbody>
    <?php
      ...
      <tr align="center">
        ...
        <td>
          <?php include('garage_kayak_view_edit.php'); ?>
          <a href="#edit<?php echo $new_id; ?>" data-toggle="modal" class="btn btn-warning btn-sm" style="color:white"><i class='fa fa-edit'></i></a>
          <a href="garage_kayak_view_delete.php?new_id=<?php echo $new_id; ?>" onclick="return confirm('Are you sure?');"><button type="submit" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
        </td>
      </tr>
    <?php } ?>
  </tbody>
