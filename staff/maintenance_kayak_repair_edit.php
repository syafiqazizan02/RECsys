  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <?php
        ...
        $stmt2 = $conn->prepare("SELECT  damage.dam_kyk_id as dam_id, damage.dam_kyk_date as dam_date, damage.rep_kyk_date as rep_date, facility.new_id as new_id, facility.new_code as new_code
            ...
            <div class="col-lg-12">
              <table class="table table-bordered" class="table table-sm">
                <thead bgcolor=#f8f8f8>
                  <tr align="center">
                    <th colspan="2"><h5>Kayak : <?php echo $newCode ?></h5></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <?php
                      $stmt3 = $conn->prepare("SELECT  damage.dam_kyk_id as dam_id, damage.dam_status_blade as dam_blade,  damage.dam_status_seat as dam_seat, damage.dam_status_hatch as dam_hatch, damage.dam_status_crack as dam_crack, damage.dam_status_leak as dam_leak, facility.new_id as new_id, facility.new_code as new_code
                                               FROM `damage_kayak` AS damage
                                               JOIN `facility_new` AS facility ON damage.new_id=facility.new_id
                      ...
                      while($trow = $result3->fetch_assoc())
                      {
                        ...
                        if($dam_blade==1){
                          ...
                          echo "<td><input type='number' name='done_blade' class='form-control'></td>";
                          echo "</tr>";
                        }else{
                          echo "<input type='hidden' name='done_blade' class='form-control'>";
                        }
                        if($dam_seat==1){
                          echo "<tr align='center'>";
                          echo "<td><p>Seat</p></td>";
                        ...
                        if($dam_hatch==1){
                          ...
                          echo "<td><input type='number' name='done_hatch' class='form-control'></td>";
                          echo "</tr>";
                        }else{
                          echo "<input type='hidden' name='done_hatch' class='form-control'>";
                        }
                        if($dam_crack==1){
                          echo "<tr align='center'>";
                          echo "<td><p>Crack</p></td>";
                          echo "<td><input type='number' name='done_carck' class='form-control'></td>";
                          echo "</tr>";
                        }else{
                          echo "<input type='hidden' name='done_carck' class='form-control'>";
                        }
                        if($dam_leak==1){
                          echo "<tr align='center'>";
                          echo "<td><p>Leak</p></td>";
