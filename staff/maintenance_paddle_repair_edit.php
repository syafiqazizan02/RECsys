  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <?php
        ...
        $stmt2 = $conn->prepare("SELECT  damage.dam_pad_id as dam_id, damage.dam_pad_date as dam_date, damage.rep_pad_date as rep_date, facility.new_id as new_id, facility.new_code as new_code
        ...
        <form action="maintenance_paddle_repair_update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
          <div class="modal-body">
            <div class="col-lg-12">
              <table class="table table-bordered" class="table table-sm">
                <thead bgcolor=#f8f8f8>
                  <tr align="center">
                    <th colspan="2"><h5>Paddle Boat : <?php echo $newCode ?></h5></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <?php
                      $stmt3 = $conn->prepare("SELECT  damage.dam_pad_id as dam_id, damage.dam_status_canopy as dam_canopy, damage.dam_status_pole as dam_pole, damage.dam_status_seat as dam_seat,damage.dam_status_paddle as dam_paddle, damage.dam_status_crack as dam_crack, damage.dam_status_leak as dam_leak, facility.new_id as new_id, facility.new_code as new_code
                      FROM `damage_paddle` AS damage
                      JOIN `facility_new` AS facility ON damage.new_id=facility.new_id
                      ...
                      while($trow = $result3->fetch_assoc())
                      {
                        ...
                        if($dam_paddle==1){
                          ...
                          echo "<td><input type='number' name='done_paddle' class='form-control'></td>";
                          echo "</tr>";
                        }else{
                          echo "<input type='hidden' name='done_paddle' class='form-control'>";
                        }
                        if($dam_crack==1){
                          echo "<tr align='center'>";
                        ...
                        if($dam_leak==1){
                          echo "<tr align='center'>";
                          echo "<td><p>Leak</p></td>";
                          echo "<td><input type='number' name='done_leak' class='form-control'></p></td>";
                          echo "</tr>";
                        }else{
